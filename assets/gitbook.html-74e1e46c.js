import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{r as a,o as d,c as l,a as e,b as n,d as t,e as o}from"./app-e53dd85b.js";const r={},c=e("h1",{id:"gitbook-安装及使用",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#gitbook-安装及使用","aria-hidden":"true"},"#"),n(" gitbook 安装及使用")],-1),u=e("h3",{id:"gitbook的安装",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#gitbook的安装","aria-hidden":"true"},"#"),n(" gitbook的安装")],-1),v=e("p",null,"首先需要安装Nodejs，这里直接安装v12.22.1版本，其他版本在安装nodejs的过程中有错误，避免入坑",-1),p={href:"https://nodejs.org/zh-cn/download/releases/",target:"_blank",rel:"noopener noreferrer"},m=o(`<blockquote><p>https://nodejs.org/zh-cn/download/releases/</p></blockquote><p>下载后解压缩，配置环境变量即可</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>λ <span class="token function">node</span> <span class="token parameter variable">-v</span>
v12.22.1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="安装使用过程中出现的错误" tabindex="-1"><a class="header-anchor" href="#安装使用过程中出现的错误" aria-hidden="true">#</a> 安装使用过程中出现的错误</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>D:\\developer\\learn\\note
gitbook build
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个直接把polyfills.js中62行到64行的代码注释掉即可</p>`,46);function b(g,h){const i=a("ExternalLinkIcon");return d(),l("div",null,[c,u,v,e("p",null,[e("a",p,[n("nodejs"),t(i)]),n("的所有历史版本可以在这里下载")]),m])}const x=s(r,[["render",b],["__file","gitbook.html.vue"]]);export{x as default};
