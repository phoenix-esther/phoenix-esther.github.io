import{_ as e,a as t,b as p,c as i,d as l,e as o}from"./image-20220511132330620-c6b6fdea.js";import{_ as c}from"./plugin-vue_export-helper-c27b6911.js";import{r as u,o as r,c as d,a as n,b as s,d as k,e as v}from"./app-9aa256ea.js";const m={},b=n("h1",{id:"jvm-内存结构",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#jvm-内存结构","aria-hidden":"true"},"#"),s(" JVM 内存结构")],-1),g=n("h2",{id:"运行时数据区",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#运行时数据区","aria-hidden":"true"},"#"),s(" 运行时数据区")],-1),f={href:"https://blog.csdn.net/xiaokanfuchen86/article/details/117625190",target:"_blank",rel:"noopener noreferrer"},h=v('<p>Java 虚拟机在执行 Java 程序的过程中会把它管理的内存划分为若干个不同的数据区域。每个区域都有各自的作用。JVM 的运行时数据区主要包括：<strong>堆、栈、方法区、程序计数器</strong>等。而 JVM 的优化问题主要在线程共享的数据区中：<strong>堆、方法区</strong>。</p><img src="'+e+`" alt="img" style="zoom:100%;"><h3 id="程序计数器" tabindex="-1"><a class="header-anchor" href="#程序计数器" aria-hidden="true">#</a> 程序计数器</h3><p>Program Counter Register 程序计数器（寄存器）</p><ul><li><p>作用，是记住下一条jvm指令的执行地址</p></li><li><p>特点</p><ul><li><p>是线程私有的</p></li><li><p>不会存在内存溢出</p></li></ul></li></ul><p>下面给出一个例子：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token number">0</span><span class="token operator">:</span> getstatic #<span class="token number">20</span>              <span class="token comment">// PrintStream out = System.out; </span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="stringtable存储位置" tabindex="-1"><a class="header-anchor" href="#stringtable存储位置" aria-hidden="true">#</a> StringTable存储位置</h4><p>Java 8 中的存储位置：</p><img src="`+l+'" alt="image-20220511132237266" style="zoom:40%;"><p>java 6 中的存储位置：</p><img src="'+o+`" alt="image-20220511132330620" style="zoom:40%;"><p>将串池转移到堆内存后，更有利于内存的回收</p><h4 id="stringtable的特性" tabindex="-1"><a class="header-anchor" href="#stringtable的特性" aria-hidden="true">#</a> StringTable的特性</h4><ul><li><p>常量池中的字符串仅是符号，第一次用到时才变为对象</p></li><li><p>利用串池的机制，来避免重复创建字符串对象</p></li><li><p>字符串变量拼接的原理是 StringBuilder （1.8）</p></li><li><p>字符串常量拼接的原理是编译期优化</p></li><li><p>可以使用 intern 方法，主动将串池中还没有的字符串对象放入串池</p><ul><li><p>1.8 将这个字符串对象尝试放入串池，如果有则并不会放入，如果没有则放入串池， 会把串池中的对象返回</p></li><li><p>1.6 将这个字符串对象尝试放入串池，如果有则并不会放入，如果没有会把此对象复制一份，放入串池， 会把串池中的对象返回</p></li></ul></li></ul><h4 id="stringtable调优" tabindex="-1"><a class="header-anchor" href="#stringtable调优" aria-hidden="true">#</a> StringTable调优</h4><p>StringTable的实现类似于Hash表，默认的桶大小是65535（在Java11中），可以使用参数-XX:StringTableSzie=655350 来进行调整。</p><p>当项目中字符串变量较多时，可以适当增加StringTable的大小，来提高运行效率。</p><h3 id="直接内存" tabindex="-1"><a class="header-anchor" href="#直接内存" aria-hidden="true">#</a> 直接内存</h3><p>优点：</p><ul><li><p>常见于 NIO 操作时，用于数据缓冲区</p></li><li><p>分配回收成本较高，但读写性能高</p></li><li><p>不受 JVM 内存回收管理</p></li></ul><p>首先来看一个例子：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * 演示 ByteBuffer 作用
 */</span>
